...
export const experiences: Experience[] = [
  {
    ...
    achievements: [
      ...
      "Developed automated NAV/TER data ingestion system that processes daily Excel uploads from collaborative banks, validates and parses fund data, stores records in database, archives files to Azure Blob Storage, and triggers email notifications to operations and business teams.",
      ...
      "Built Zoho CRM integration using event queuing and scheduled batch processing with retry mechanisms and backfill utilities, enabling business teams to monitor customer journeys and troubleshoot issues via synced activity data and error messages.",
    ],
    technologies: [
      "Spring Boot",
      "Quarkus",
